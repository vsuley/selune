    ...
    extend: {
      colors: {
        ...
        synthwave: {
          ...
          grid: {
            light: 'rgba(131, 56, 236, 0.1)',
            medium: 'rgba(131, 56, 236, 0.3)',
            heavy: 'rgba(131, 56, 236, 0.5)',
          },
        },
      },
      spacing: {
      ...
      boxShadow: {
        ...
        'neon-blue': '0 0 10px rgba(58, 134, 255, 0.5), 0 0 20px rgba(58, 134, 255, 0.3)',
        'neon-teal': '0 0 10px rgba(6, 255, 165, 0.5), 0 0 20px rgba(6, 255, 165, 0.3)',
      },
    },
  },
  plugins: [],
